      ...
      <nav className="navbar navbar-expand-lg">
        ...
        <div className="container-fluid w-100">
          <div className="d-flex align-items-center">
            <a
              href="#"
              className={`arrow-icon d-xl-block d-lg-block d-md-none d-none ${collapsed ? 'open' : ''}`}
              id="sidebarCollapse"
              onClick={handleClick}
            >
          ...
          <div className="mx-4 d-lg-block d-xl-block d-sm-block d-md-block d-none">
            {user_auth && (
              <div className="text-center w-100">
                <span className="mb-0">
                  Ciao <label className="ct-primary fw-bold">{user_auth.name}</label>, Benvenuto in Quick CMS
                </span>
              </div>
            )}
          </div>
          ...
          <div className="d-flex align-items-center">
            ...
            <div
              className="navbar-collapse d-lg-block d-xl-block d-sm-none d-md-none d-none"
                  ...
                  {!user_auth ? (
                    ...
                    <ul>
                      <li className="nav-item dropdown">
                        <a
                          id="navbarDropdown"
                          className="nav-link user user-box "
                          href="#"
                          role="button"
