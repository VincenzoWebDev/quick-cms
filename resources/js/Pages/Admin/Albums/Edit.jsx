...
const AlbumEdit = ({ album, categories, selectedCategory, flash }) => {
  useEffect(() => {
    if (flash?.message) {
          ...
          <div className="col-md-8">
            <form onSubmit={handleSubmit} encType="multipart/form-data">
              <div className="tab-content" id="myTabContent">
                ...
                >
                  <div className="mb-3">
                    <label htmlFor="album_name" className="form-label fw-bold">
                      Nome album
                    </label>
                    <input
                      type="text"
              ...
              <div className="mb-3">
                ...
                <Link href={route('albums')} className="btn btn-secondary">
                  Torna indietro
                </Link>
              </div>
            </form>
