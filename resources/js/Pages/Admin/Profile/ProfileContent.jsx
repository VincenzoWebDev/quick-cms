...
const ProfileContent = ({ user_auth }) => {
    ...
    const handleSaveClick = (e) => {
        e.preventDefault();
        patch(route('profile.update', user_auth.id), {
            onSuccess: (res) => {
                setEditable(false);
                        ...
                        <div className="card">
                            <div className="card-body">
                                <div className="d-flex flex-column align-items-center text-center">
                                    <img src={user_auth.profile_img} alt={user_auth.name} title={user_auth.name} className="rounded-circle img-fluid" width="auto" />
                                    <div className="mt-3">
