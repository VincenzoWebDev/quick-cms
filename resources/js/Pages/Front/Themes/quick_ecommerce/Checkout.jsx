                            ...
                            <div className="card shadow-0 border">
                                <div className="p-4">
                                    ...
                                    <div className="float-end">
                                        <Link href={route('home')} className="btn btn-light border me-2">Indietro</Link>
                                ...
                                {cartItems.map(item => (
                                    <div className="d-flex align-items-center mb-4" key={item.id}>
                                        <div className="me-3 position-relative col-md-4">
                                            ...
                                            <Link href={route('productDetail.index', { 'slug': item.product.slug, 'id': item.product.id })} className="nav-link">
                                                <img
