<nav id="sidebar">
    ...
    <ul class="list-unstyled components">
        ...
        <li class="{{ Str::startsWith(request()->path(), 'admin/users') ? 'active' : '' }}">
            <a href="/admin/users" class="users"><i class="material-icons">person</i><span>users</span></a>
        </li>

        <li class="{{ Str::startsWith(request()->path(), 'admin/albums') ? 'active' : '' }}">
            <a href="/admin/albums" class="albums"><i class="material-icons">photo_library</i><span>Albums</span></a>
        </li>

        <li class="{{ Str::startsWith(request()->path(), 'admin/photos') ? 'active' : '' }}">
